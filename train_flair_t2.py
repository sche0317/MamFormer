...
x_set = torch.load('./data/brats_data/flair_gaussian.pth')
y_set = torch.load('./data/brats_data/t2_gaussian.pth')
train_dataset = TensorDataset(x_set, y_set)
train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True, drop_last=True)

x_valid_set = torch.load('./data/brats_data/flair_core_gaussian.pth')
y_valid_set = torch.load('./data/brats_data/t2_core_gaussian.pth')
valid_dataset = TensorDataset(x_valid_set, y_valid_set)
